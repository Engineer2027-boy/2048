...
public class twothousandfortyeight {
    ...
    public static int[][] moveStuff(int[][] x) {
        ...
        return x;
    }public static void whatifminusone(int[][] x) {
    ...
    }public static void whatifplusone(int[][] x) {
        for (int i = 0; i < 4; i++) {
            for(int j = 0; j < 4; j++){
                if (x[i][j] == 2) {
                    boolean has_been_multiplied = false;
    ...
    }public static void whatifplustwo(int[][] x){
        for(int i = 0; i < 4; i++){
            for(int j = 0; j < 4; j++){
                if(x[i][j] == 2){
                    boolean has_been_multiplied = false;
    ...
    }public static void whatifminustwo(int[][] x){
        for(int i = 0; i < 4; i++){
            for(int j = 0; j < 4; j++){
                if(x[i][j] == 2) {
                    boolean has_been_multiplied = false;
